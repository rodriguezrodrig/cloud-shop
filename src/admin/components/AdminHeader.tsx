...
import { Search, Bell, MessageSquare, Settings, PowerOff  } from 'lucide-react';
    ...
    <header className="bg-white border-b border-gray-200 px-6 py-4 h-18">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="p-2 text-red-600 hover:bg-red-100 rounded-lg transition-colors" onClick={handleLogout}>           
            <PowerOff size={20} />            
          </button>
